...
#$specail_text = "+100 attack AT, +1 range.";
#$specail_text = "+200 melee attack AT. If your melee attack hits an enemy Zoid, move it 2 squares backwards. If it cannot move, such as if a base or barricade is in the way, it loses a further 200 HP instead of moving. *Can only be equipped on S or M-class Zoids.";
