...
$database_text= array("1100","800", "500", "6", "");
...
#constant text
$text = array("Attack", "Shoot", "Melee", "Area", "Defense", "Mobility", "Aptitude");
...
$Y_positions = array($yellow_mid+6, 420 + $text_size, 468 - 3, $yellow_mid+6, $yellow_mid+6, $green_mid+6, $green_mid+6);
$X_positions = array(28+1, 105, 105, 228+$base_offset, 320, 28+1,228+$base_offset);
$database_Y_positions = array(420 + $text_size, 468 - 3, $yellow_mid+6,478 + $text_size, 525-3);
$database_X_positions = array(218,218, 415,218, 218);
