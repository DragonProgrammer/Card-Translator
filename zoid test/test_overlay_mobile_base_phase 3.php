...
$Y_positions = array(420+$text_size, 420 + $text_size, 468 - 3, 420 + $text_size, 420 + $text_size, $green_mid+6, $green_mid+6);
$X_positions = array(28+1, 105, 28+1, 228+$base_offset, $defense_start, 28+1,228+$base_offset);
...
imageline($image_sized,29,$yellow_mid-1,223,$yellow_mid-1, $yellow_shadow);
imageline($image_sized,29,$yellow_mid,223,$yellow_mid, $yellow_divide);
